        ...
        return (
            <div class="h-full  from-green-400 to-indigo-900 w-full py-16 px-4">
                <div class="flex flex-col items-center justify-center">
                    <div class="card w-96 bg-base-100 shadow-xl lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                        <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-600">Login ke akunmu</p>
                        <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-400">Tidak punya akun? <Link to="/register" class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-600 cursor-pointer">Daftar disini</Link></p>
                        <button aria-label="Continue with google" class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                            ...
                            <p class="text-base font-medium ml-4 text-gray-700">Masuk dengan Google</p>
                        </button>
                        <button aria-label="Continue with facebook" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                            ...
                            <p class="text-base font-medium ml-4 text-gray-700">Masuk dengan Facebook</p>
                        </button>
                        <button aria-label="Continue with twitter" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                            ...
                            <p class="text-base font-medium ml-4 text-gray-700">Masuk dengan Twitter</p>
                        </button>
                        <div class="w-full flex items-center justify-between py-5">
                            <hr class="w-full bg-gray-400" />
                            <p class="text-base font-medium leading-4 px-2.5 text-gray-400">atau</p>
                            <hr class="w-full bg-gray-400  " />
                        </div>
                        <div>
                            ...
                            <input aria-labelledby="email" type="email" class="input input-bordered py-3 w-full pl-3 mt-2" />
                        </div>
                        <div class="mt-6  w-full">
                            ...
                            <div class="relative flex items-center justify-center">
                                <input id="pass" type="password" class="input input-bordered py-3 w-full pl-3 mt-2" />
                        ...
                        <div class="mt-8">
                            <button class="btn btn-active btn-primary py-4 w-full">Login</button>
                        </div>
                    </div>
                </div>
            </div>
